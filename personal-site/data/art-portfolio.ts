...
export const artModules: readonly ArtModuleEntry[] = [
  ...
  },
  {
    ...
    eyebrow: "Module 02",
    description:
      "Oil and acrylic works centered on florals, color fields, and layered surface texture.",
    cta: "View paintings",
    image: "/art/painting/white-flowers-yellow.jpg",
    imageClassName: "object-cover object-center",
    baseScale: 1.02,
    variant: "standard",
    detailEyebrow: "Painting / Surface",
    detailTitle: "Floral studies, bold color fields, and the material surface of paint.",
    detailBody:
      "The painting chapter now reads as a fuller body of work rather than a single study. It moves through floral compositions, a textured holiday painting, and a blue-flower piece shown both in progress and in its finished form, so the page carries both final images and process.",
    detailNote:
      "This wall can keep growing with more canvases later, but it already has enough variation now to read like a real painting section instead of a placeholder.",
    accent: "#7f6942",
    gallery: [
      {
        src: "/art/painting/white-flowers-yellow.jpg",
        alt: "White flowers in a yellow vase on a yellow ground",
        title: "White Flowers on Yellow",
        note: "A full composition where white petals and the yellow field hold the entire painting in one warm register.",
        size: "portrait",
      },
      {
        src: "/art/painting/blue-flowers-final.jpg",
        alt: "Blue flowers painting on a bright yellow background",
        title: "Blue Flowers",
        note: "A stronger contrast piece built from saturated blue petals against a flat yellow ground.",
        size: "portrait",
      },
      {
        src: "/art/painting/blue-flowers-process.jpg",
        alt: "In-progress photo of a blue flowers painting on an easel",
        title: "Blue Flowers Process",
        note: "The unfinished stage keeps the underdrawing, setup, and revision marks visible.",
        size: "landscape",
      },
      {
        src: "/art/painting/pink-garden.jpg",
        alt: "Pink floral painting on a dark background",
        title: "Pink Garden",
        note: "A denser floral field where blossoms scatter across a darker ground and build a different rhythm.",
        size: "square",
      },
      {
        src: "/art/painting/pink-garden-detail.jpg",
        alt: "Close-up detail of pink floral painting",
        title: "Pink Garden Detail",
        note: "A tighter crop that brings the brushwork and repeated petal shapes forward.",
        size: "landscape",
      },
      {
        src: "/art/painting/christmas-tree.jpg",
        alt: "Textured Christmas tree painting with snow and handwritten text",
        title: "Christmas Tree",
        note: "A more tactile painting where relief texture and writing become part of the image.",
        size: "landscape",
      },
    ],
  },
  ...
  },
  {
    ...
    eyebrow: "Module 05",
    description:
      "Photography studies of blossoms, snow, autumn leaves, motion, and city atmosphere.",
    ...
    detailTitle: "Blossoms, snow, autumn leaves, and motion gathered into one seasonal sequence.",
    detailBody:
      "This chapter now leans more clearly into season and atmosphere: spring blossoms, winter scenes, autumn leaves, urban views, and intentional motion blur. The gallery is arranged to feel less like a neat feed and more like a wall of prints moving between stillness and movement.",
    detailNote:
      "The right side is now sequenced more deliberately by mood, so future photographs can keep sliding into the seasonal rhythm without needing a redesign.",
    accent: "#7c5a2f",
    gallery: [
      {
        src: "/art/photography/snow-lake-birds.jpg",
        alt: "Wide winter lake scene with birds over snowy trees",
        title: "Snow Lake",
        note: "A panoramic winter still with birds cutting through the pale sky.",
        size: "wide",
      },
      {
        src: "/art/photography/snow-bridge.jpg",
        alt: "Snow-covered bridge reflected in still water",
        title: "Snow Bridge",
        note: "A quieter vertical frame built from reflection, arch, and bare branches.",
        size: "portrait",
      },
      {
      ...
      {
        src: "/art/photography/maple-sky.jpg",
        alt: "Backlit red maple leaves against a blue sky",
        title: "Maple Sky",
        note: "Backlit autumn leaves pushed into a brighter, sharper color register.",
        size: "square",
      },
      {
        src: "/art/photography/maple-window.jpg",
        alt: "Red maple leaves lit against dark architecture",
        title: "Maple Window",
        note: "A warmer autumn study where the leaves read almost like cut paper against shadow.",
        size: "square",
      },
      {
      ...
      {
        src: "/art/story-tree.jpg",
        alt: "Golden tree photographed with rotational motion blur",
        title: "Golden Spiral",
        note: "Camera movement turns the tree into a circular field of yellow and blue.",
        size: "square",
      },
      {
        src: "/art/photography/green-spiral.jpg",
        alt: "Green tunnel photographed with rotational motion blur",
        title: "Green Spiral",
        note: "A brighter motion study where foliage and path dissolve into a spinning tunnel.",
        size: "square",
      },
      {
        src: "/art/photography/flower-spiral.jpg",
        alt: "Orange and pink flowers photographed with rotational blur",
        title: "Flower Spiral",
        note: "A floral motion blur that keeps color intensity while loosening the form.",
        size: "square",
      },
      {
